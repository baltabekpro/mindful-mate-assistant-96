    ...
    <CarouselItem className="h-screen flex items-center justify-center">
      <div className="text-white space-y-8 p-8 max-w-4xl mx-auto">
        <div className="grid grid-cols-2 gap-8">
          <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 animate-summary-rotate">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 animate-summary-rotate [animation-delay:200ms]">
            <div className="flex items-center gap-4 mb-4">
