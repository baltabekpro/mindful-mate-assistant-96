  ...
  return (
    <CarouselItem className="h-screen flex items-center justify-center">
      <div className="text-white space-y-8 p-8 max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-8 animate-fade-in">Персональные рекомендации</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="opacity-0 animate-unfold [animation-delay:200ms]">
          ...
          <div className="opacity-0 animate-unfold [animation-delay:400ms]">
            <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6">
              <div className="flex items-center gap-4 mb-6">
          ...
          <div className="md:col-span-2 opacity-0 animate-unfold [animation-delay:600ms]">
            <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6">
              <div className="flex items-center gap-4 mb-6">
